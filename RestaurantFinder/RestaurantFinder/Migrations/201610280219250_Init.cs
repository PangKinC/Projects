    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        PriceRange = c.Decimal(precision: 18, scale: 2),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.RestaurantDetails", t => t.RestaurantID, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.RestaurantReviews", "RestaurantID", "dbo.RestaurantDetails");
